...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'links_link', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=220, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=2400, null=True, blank=True)),
